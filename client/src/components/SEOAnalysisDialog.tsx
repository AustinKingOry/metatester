...
const SEOAnalysisDialog: React.FC<SEOAnalysisDialogProps> = ({ insights }) => {
    ...
    const modalTitle = "SEO Analysis";
    const modalDescription = "Review your website's SEO performance and get insights to improve.";
    ...
    if (isDesktop) {
        return (
            ...
            <DialogContent className="sm:max-w-[625px] max-h-[80vh] flex flex-col pr-2">
                ...
                <AnalysisBody insights={insights} />
            </DialogContent>
        </Dialog>
        )
    }
    return (
        ...
        <DrawerContent className="max-h-[90%]">
            ...
            <DrawerDescription className="flex flex-row space-x-2 items-center">
                {modalDescription}
            </DrawerDescription>
            </DrawerHeader>
            <div className="p-3 max-h-[90%] overflow-y-scroll">                
            <AnalysisBody insights={insights} />
            </div>
...
const AnalysisBody: React.FC<SEOAnalysisDialogProps> = ({ insights }) => { 
    if (!insights) {
      return null;
    }
